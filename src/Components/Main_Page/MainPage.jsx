    ...
    return (
        <>
            ...
            <div className="main-page">
                ...
                <div className={signin ? "signinpage" : "signinpage closed"}>
                    <div className="main-signin-form">
                        <section className="container forms">
                            <div className="form login">
                                <div className="form-content">
                                    <i class="fa-solid fa-xmark" onClick={signinbtn}></i>
                                    <header>Login</header>
                                    <form action="#">
                ...
                <div className={signup ? "signuppage" : "signuppage closed"}>
                    <div className='main-signup-form'>
                    <section className="container forms">
                            <div className="form login">
                                <div className="form-content">
                                <i class="fa-solid fa-xmark" onClick={signupbtn}></i>
                ...
                <nav className={menu ? "menu-nav" : "nav"}>
                    ...
                    <div className="main-page-btn">
                        <span>
                            <button className='sign-btns' onClick={signinbtn}>Sign in</button>
                            <button className='sign-btns'onClick={signupbtn}>Sign up</button>
                            <button id='diff-padd' onClick={menuoption}><i className="fa-solid fa-bars-staggered"></i></button>
                        </span>
                    </div>
                </nav>
